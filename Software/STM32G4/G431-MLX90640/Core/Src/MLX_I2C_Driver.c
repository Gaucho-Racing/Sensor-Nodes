...
int MLX90640_I2CRead(uint8_t slaveAddr, uint16_t startAddress, uint16_t nMemAddressRead, uint16_t* data)
{
    ...
    if (HAL_I2C_Mem_Read(&hi2c2, (slaveAddr << 1), startAddress, I2C_MEMADD_SIZE_16BIT, p, nMemAddressRead * 2, HAL_MAX_DELAY) != HAL_OK)
    {
...
int MLX90640_I2CWrite(uint8_t slaveAddr, uint16_t writeAddress, uint16_t data)
{
    ...
    if (HAL_I2C_Mem_Write(&hi2c2, slaveAddr << 1, writeAddress, I2C_MEMADD_SIZE_16BIT, cmd, 2, 1000) != HAL_OK)
    {
