...
/*
So this first reads the data in CTRL REG
потом пишет ето говно в CTRL_REG 1 << 15
...
float MLX90640_GetTa(uint16_t *frameData, const paramsMLX90640 *params)
{
    ...
    uint16_t ptat_tmp = frameData[800];
    memcpy(&ptat, &frameData[800], 2);
...
static void ExtractGainParameters(uint16_t *eeData, paramsMLX90640 *mlx90640)
{
    mlx90640->gainEE = 6000;//(int16_t)eeData[48];;    
}
